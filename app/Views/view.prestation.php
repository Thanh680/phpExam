...
if(!isset($_SESSION['user'])) {
  ...
  <div class="row justify-content-center">
    ...
    <div class="collapse" id="collapseCreate">
      ...
      <form action="admin.php?action=createPrestation" method="post">
        ...
        <div class="text-center">
          <br>
          <button type="submit" name="createPrestation" class="btn btn-outline-success" value="createPrestation">Créer</button>
        </div>
      </form>
      </div>
    </div>
            ...
            foreach ($tabPresta as $value) {
              echo '
                <tr>
                  ...
                  <form action="admin.php?action=deletePrestation" method="post">
                      <input type="hidden" id="id" name="id" value='.$value['id'].'>
                      <input type="submit" class="btn btn-primary" name="deletePrestation" value="Supprimer">
                  </form>
                  </td>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="editModal'.$value['id'].'">Modfier la prestation</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                      </div>
                      <div class="modal-body">
                      <form action="admin.php?action=editPrestation" method="post">
                        <div class="form-group">
                          <label for="libelle">Libellé</label><br>
                          <input type="hidden" id="id" name="id" value='.$value['id'].'>
